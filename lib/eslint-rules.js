...
function define(category, targetSystems, ruleConfig)
{
    ...
    {
    case 'object':
        ({ applyToTS, minEcmaVersion } = targetSystems);
        break;
    case 'number':
        applyToTS = true;
        minEcmaVersion = targetSystems;
        break;
    case 'string':
        applyToTS = targetSystems === 'ts';
        minEcmaVersion = NaN;
        break;
    ...
    const definition = { applyToTS, category, minEcmaVersion, ruleConfig };
    return definition;
}
...
function withoutTS(minEcmaVersion)
{
    const targetSystems = { applyToTS: false, minEcmaVersion };
